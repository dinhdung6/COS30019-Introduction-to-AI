...
def greedy_best_first_search(map_grid, start, goals, use_jumps=False):
    ...
    while priority_queue:
        ...
        for next_x, next_y, cost in neighbors:
            if (next_x, next_y) not in visited_nodes and map_grid.is_within_limits(next_x, next_y):
                ...
                priority_queue.append((heuristic_value, SearchNode(next_x, next_y, current_node, current_node.travel_cost + cost)))
